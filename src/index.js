...
export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname.endsWith('.html') || !url.pathname.includes('.')) {
      headers.set('Content-Security-Policy', "default-src 'self' https: http: data: blob: 'unsafe-inline' 'unsafe-eval'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://checkout.razorpay.com https://*.razorpay.com https://cdn.razorpay.com https://code.jquery.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://www.googletagmanager.com https://www.google-analytics.com https://static.cloudflareinsights.com https://cdn.trustindex.io https: http:; script-src-elem 'self' 'unsafe-inline' 'unsafe-eval' https://checkout.razorpay.com https://*.razorpay.com https://cdn.razorpay.com https://code.jquery.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://www.googletagmanager.com https://www.google-analytics.com https://static.cloudflareinsights.com https://cdn.trustindex.io https: http:; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://cdn.trustindex.io https: http:; style-src-elem 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://cdn.trustindex.io https: http:; font-src 'self' data: https://fonts.gstatic.com https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https: http:; img-src 'self' data: blob: https: http: https://media.heelsup.in https://*.unsplash.com https://*.razorpay.com https://cdn.razorpay.com https://*.r2.dev https://*.workers.dev https://cdn.trustindex.io; connect-src 'self' https: http: https://media.heelsup.in https://*.heelsup.workers.dev https://*.workers.dev https://api.razorpay.com https://lumberjack.razorpay.com https://cdn.jsdelivr.net https://code.jquery.com https://cdnjs.cloudflare.com https://nominatim.openstreetmap.org https://www.google-analytics.com https://www.googletagmanager.com https://static.cloudflareinsights.com https://cdn.trustindex.io; frame-src 'self' https: http: https://*.razorpay.com https://api.razorpay.com https://cdn.trustindex.io; worker-src 'self' blob:; manifest-src 'self'; base-uri 'self'; form-action 'self';");
    }
