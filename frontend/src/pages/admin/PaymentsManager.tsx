          ...
          <div className="flex items-center gap-2">
            <div className="relative">
              ...
              <input
                ...
                className="h-7 pl-8 pr-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-xs w-56 focus:outline-none font-mono"
              />
            </div>
            ...
            <Button
              ...
              size="sm"
              variant="outline"
              className="h-7 text-xs px-2.5 border-indigo-200 dark:border-indigo-800 text-indigo-600 dark:text-indigo-400 font-semibold flex items-center gap-1"
            >
            ...
            <Button
              ...
              size="sm"
              className="h-7 text-xs px-2.5 bg-indigo-600 hover:bg-indigo-700 text-white font-semibold flex items-center gap-1.5 shadow-xs"
            >
